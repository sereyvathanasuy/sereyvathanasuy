 ...
 */
{
  ...
  class HoverImgFx1 {
    constructor(el) {
      ...
      this.DOM.reveal.innerHTML = `<div class="tg-img-reveal-wrapper__inner">
                <div class="tg-img-reveal-wrapper__img" style="background-image:url(${
                  this.DOM.el.dataset.img
                })">
                    <div class="tg-hover-wrapper" >
                        <ul class="tgbanner__content-meta list-wrap">
                            <li><span class="by">By</span> <a href="#">${
                              this.DOM.el.dataset.author
                                ? this.DOM.el.dataset.author
                                : ""
                            }</a></li>
                            <li>${
                              this.DOM.el.dataset.date
                                ? this.DOM.el.dataset.date
                                : ""
                            }</li>
                        </ul>
                        <h3 class="tg-hover-title">${
                          this.DOM.el.dataset.title
                            ? this.DOM.el.dataset.title
                            : ""
                        }</h3>
                    </div>
  ...
  [
    ...document.querySelectorAll(
      '[data-fx="pt1"] > .tg-img-reveal-item, .tg-img-reveal-item[data-fx="pt1"]'
    ),
  ].forEach((link) => new HoverPTCard1(link));
  [
    ...document.querySelectorAll(
      '[data-fx="1"] > .tg-img-reveal-item, .tg-img-reveal-item[data-fx="1"]'
    ),
