...
!(function (e, t) {
  ...
  function F() {
    return (De && De.isPressed) || ze.cache++;
  }
  function G(r, n) {
    function Yc(e) {
      if (e || 0 === e) {
        ...
        (e = Yc.v = Math.round(e) || (De && De.iOS ? 1 : 0)),
          ...
          (Yc.cacheID = ze.cache),
          t && o("ss", e);
      } else (n || ze.cache !== Yc.cacheID || o("ref")) && ((Yc.cacheID = ze.cache), (Yc.v = r()));
  ...
  function P(e) {
    return (
      (Se = e || r()) &&
        ...
        document.body &&
        ((ke = window),
        (Ee = (Te = document).documentElement),
        (Pe = Te.body),
        (t = [ke, Te, Ee, Pe]),
        Se.utils.clamp,
    ...
    Le = {
      ...
      sc: G(function (e) {
        return arguments.length
          ? ke.scrollTo(e, Ie.sc())
          : ke.pageXOffset || Te[n] || Ee[n] || Pe[n] || 0;
      }),
    },
    Ie = {
      s: a,
      ...
      sc: G(function (e) {
        return arguments.length
          ? ke.scrollTo(Le.sc(), e)
          : ke.pageYOffset || Te[a] || Ee[a] || Pe[a] || 0;
      }),
    };
  (Le.op = Ie), (ze.cache = 0);
  var T =
    ((Observer.prototype.init = function init(e) {
      ...
      function gf(e) {
        if (!Xe(e)) {
          ...
          var t =
            ...
            f;
          $e(e.deltaX * t, e.deltaY * t, 0), l && !q && te.restart(!0);
        }
      }
      function hf(e) {
        if (!Xe(e)) {
      ...
      (this.target = o = J(o) || Ee),
        ...
        (n = !1 !== n),
        (r = r || parseFloat(ke.getComputedStyle(Pe).lineHeight) || 22);
      var ee,
        te,
        re,
        ne,
      ...
      (te = se._dc =
        ...
        (se.disable = function () {
          se.isEnabled &&
            ...
            se.isPressed &&
              (se._vx.reset(), se._vy.reset(), C(q ? o : ve, Re[1], af, !0)),
    ...
    ee =
      ((ScrollTrigger.prototype.init = function init(M, O) {
        if (
          ...
          var A,
            ...
            S,
            o,
            C = (M = jb(pt(M) || Pa(M) || M.nodeType ? { trigger: M } : M, Tt))
              .onUpdate,
            k = M.toggleClass,
            a = M.id,
            T = M.onToggle,
            ...
            we = "markers" in M ? M.markers : Tt.markers,
          ...
          if (
            ...
            (F = this.markerStart = yb("start", a, u, ge, e, t, 0, pe)),
              (q = this.markerEnd = yb("end", a, u, ge, e, t, 0, pe)),
              pe && (S = Ne.quickSetter([F, q], ge.a, St)),
              ye ||
          ...
          if (
              ...
              if (!pe || r || e) {
                ...
                if (
                  ...
                  !ue || A.tween || Qe || lt || te.restart(!0),
                    k &&
                      (s || (ce && p && (p < 1 || !it))) &&
                      Ve(k.targets).forEach(function (e) {
            ...
            (Ce.enable = function (e, t) {
              Ce.enabled ||
                ...
                ke && rb(ScrollTrigger, "refreshInit", ke),
            ...
            (Ce.disable = function (e, t) {
              if (
                ...
                (re = 0),
                n && (n.uncache = 1),
                ke && sb(ScrollTrigger, "refreshInit", ke),
      ...
      (ScrollTrigger.disable = function disable(t, r) {
        ...
        for (var e = 0; e < ze.length; e += 3)
          tb(sb, ze[e], ze[e + 1]), tb(sb, ze[e], ze[e + 2]);
      }),
      (ScrollTrigger.enable = function enable() {
        if (
          ...
          for (
            ...
            tb(sb, ze[t], ze[t + 1]), tb(sb, ze[t], ze[t + 2]);
        }
      }),
      ...
      (ScrollTrigger.scrollerProxy = function scrollerProxy(e, t) {
        var r = J(e),
          ...
          i = Ha(r);
        ~n && ze.splice(n, i ? 6 : 2),
          t && (i ? Fe.unshift(He, t, Je, t, je, t) : Fe.unshift(r, t));
      }),
  ...
  function qc(e, t, r, n) {
    return T.create({
      ...
      onEnable: function onEnable() {
        return r && rb(Ge, T.eventTypes[0], ie, !1, !0);
      },
      onDisable: function onDisable() {
        return sb(Ge, T.eventTypes[0], ie, !0);
      },
    });
  }
  function uc(e) {
    ...
    return (
      ...
      (e.onEnable = function () {
        nc(d, !f && "x"),
          ee.addEventListener("refresh", tq),
          rb(He, "resize", tq),
          b.smooth &&
      ...
      (e.onDisable = function () {
        nc(d, !0),
          sb(He, "resize", tq),
          ee.removeEventListener("refresh", tq),
          S.kill();
      }),
      (e.lockAxis = !1 !== e.lockAxis),
      ((n = new T(e)).iOS = E) && !b() && b(1),
      E && Ne.ticker.add(Da),
      (s = n._dc),
      (a = Ne.to(n, {
        ease: "power4",
